                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }} transition={{ duration: 0.2 }} className="bg-black border border-neutral-800 rounded-lg py-3 text-sm font-medium hover:border-amber-500 transition-colors">Yes</motion.button>
                                            <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }} transition={{ duration: 0.2 }} className="bg-black border border-neutral-800 rounded-lg py-3 text-sm font-medium hover:border-amber-500 transition-colors">No</motion.button>
                                        </div>
                                    </div>
                                    <div className="space-y-3">
                                        ...
                                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                            {['Immediately', 'Within 3 Months', '3–6 Months', 'Just Exploring'].map((time) => (
                                                <motion.button
                                                    ...
                                                    className="bg-black border border-neutral-800 rounded-lg py-3 text-xs font-medium hover:border-amber-500 transition-colors"
                                                >
                                                    {time}
                                                </motion.button>
                                            ))}
